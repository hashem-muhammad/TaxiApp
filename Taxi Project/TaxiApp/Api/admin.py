...
from Api.models import CarType, Complain, Coupon, Driver, DriverLocation, DriverReview, Driverbalance, Message, Price, Role, StopPoint, Trip, TripCancellation, TripReview, TripType, User
